...
from headers import get_nav, get_description, get_package_links, generate_package_header, distro_selector_html, distro_selector_with_eol_toggle_html, index_link_html, doc_html, get_loaded_distros
...
def macro_PackageHeader(macro, arg1, arg2=None):
    ...
    if not opt_distro:
        ...
        html += index_link_html(package_name)
