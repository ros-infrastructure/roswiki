...
def macro_PackageHeader(macro, arg1, arg2=None):
    ...
    if not opt_distro:
        ...
        if last_edit_delta.days >= threshold:
            ...
            html += 'If you run into problems, please go to <a href="http://answers.ros.org/">answers.ros.org</a> '
            html += 'and engange the community to ensure that the content is still up-to-date.</p>'
            html += '</div>'
        #
