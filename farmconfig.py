...
wikis = [
    ...
    # ---------------------------------------------------------------
#    ("prwiki", r".*$"),   # this is ok for a single wiki
#    ("prwiki", r".*/wiki.*$"),   # this is ok for a single wiki
#    ("wgwiki", r".*/wgwiki.*$"),   # this is ok for a single wiki
#    ("roswiki",    r"^www.ros.org/.*$"),   # this is ok for a single wiki
    ("roswiki",    r".*$"),   # this is ok for a single wiki
...
class FarmConfig(DefaultConfig):
    ...
    mail_from = u"Moin <moin@ros.osuosl.org>"
